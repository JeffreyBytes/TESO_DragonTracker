...
ZO_CreateStringId("SI_DRAGON_TRACKER_GUI_REPOP",  ": Erscheint in ~%d %s")
...
-- %s : Time unit (see "GUI Timer" translations)
ZO_CreateStringId("SI_DRAGON_TRACKER_GUI_STATUS", ": %s seit %d %s")
...
-- Bindings
ZO_CreateStringId("SI_BINDING_NAME_DRAGON_TRACKER_TOGGLE", "Ein-/Ausblenden")
